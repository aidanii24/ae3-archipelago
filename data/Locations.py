...
from .Strings import APHelper, Events, Loc, Meta, Stage
...
## Monkeys
# Zero
MONKEYS_ZERO: Sequence[str] = [Loc.zero_ukki_pan.value]

# Seaside
MONKEYS_SEASIDE_A: Sequence[str] = [
    Loc.seaside_nessal.value,
    Loc.seaside_ukki_pia.value,
    Loc.seaside_sarubo.value,
    Loc.seaside_salurin.value,
    Loc.seaside_ukkitan.value,
    Loc.seaside_morella.value,
]

MONKEYS_SEASIDE_B: Sequence[str] = [Loc.seaside_ukki_ben.value]

MONKEYS_SEASIDE_C: Sequence[str] = [
    Loc.seaside_kankichi.value,
    Loc.seaside_tomezo.value,
    Loc.seaside_kamayan.value,
    Loc.seaside_taizo.value,
]

MONKEYS_SEASIDE: Sequence[str] = [*MONKEYS_SEASIDE_A, *MONKEYS_SEASIDE_B, *MONKEYS_SEASIDE_C]

# Woods
MONKEYS_WOODS_A: Sequence[str] = [
    Loc.woods_ukki_pon.value,
    Loc.woods_ukkian.value,
    Loc.woods_ukki_red.value,
    Loc.woods_rosalin.value,
]

MONKEYS_WOODS_B: Sequence[str] = [Loc.woods_salubon.value, Loc.woods_wolfmon.value, Loc.woods_ukiko.value]

MONKEYS_WOODS_C: Sequence[str] = [
    Loc.woods_lambymon.value,
    Loc.woods_kreemon.value,
    Loc.woods_ukkilei.value,
    Loc.woods_spork.value,
]

MONKEYS_WOODS_D: Sequence[str] = [
    Loc.woods_king_goat.value,
    Loc.woods_marukichi.value,
    Loc.woods_kikimon.value,
    Loc.woods_kominato.value,
]

MONKEYS_WOODS: Sequence[str] = [*MONKEYS_WOODS_A, *MONKEYS_WOODS_B, *MONKEYS_WOODS_C, *MONKEYS_WOODS_D]

# Castle
MONKEYS_CASTLE_A1: Sequence[str] = [Loc.castle_ukkido.value]

MONKEYS_CASTLE_B: Sequence[str] = [Loc.castle_pipo_guard.value, Loc.castle_ukkinee.value]

MONKEYS_CASTLE_B1: Sequence[str] = [Loc.castle_monderella.value, Loc.castle_ukki_ichi.value]

MONKEYS_CASTLE_C: Sequence[str] = [
    Loc.castle_saru_mon.value,
    Loc.castle_monga.value,
    Loc.castle_ukkiton.value,
    Loc.castle_king_leo.value,
]

MONKEYS_CASTLE_D: Sequence[str] = [Loc.castle_ukkii.value]

MONKEYS_CASTLE_D1: Sequence[str] = [Loc.castle_saluto.value]

MONKEYS_CASTLE_E: Sequence[str] = [
    Loc.castle_kings_double.value,
    Loc.castle_mattsun.value,
    Loc.castle_miya.value,
    Loc.castle_mon_san.value,
]

MONKEYS_CASTLE_F: Sequence[str] = [Loc.castle_sal_1000.value]
...
MONKEYS_CISCOCITY_A: Sequence[str] = [
    Loc.ciscocity_ukima.value,
    Loc.ciscocity_monbolo.value,
    Loc.ciscocity_pipo_mondy.value,
    Loc.ciscocity_ukki_mattan.value,
    Loc.ciscocity_bemucho.value,
    Loc.ciscocity_ukki_nader.value,
]

MONKEYS_CISCOCITY_B: Sequence[str] = [
    Loc.ciscocity_sabu_sabu.value,
    Loc.ciscocity_ginjiro.value,
    Loc.ciscocity_kichiemon.value,
]

MONKEYS_CISCOCITY_C: Sequence[str] = [Loc.ciscocity_ukkilun.value]

MONKEYS_CISCOCITY_D: Sequence[str] = [
    Loc.ciscocity_bully_mon.value,
    Loc.ciscocity_ukki_joe.value,
    Loc.ciscocity_tamaki.value,
    Loc.ciscocity_mickey_oou.value,
]

MONKEYS_CISCOCITY_E: Sequence[str] = [
    Loc.ciscocity_sally_kokoroe.value,
    Loc.ciscocity_monkey_manager.value,
    Loc.ciscocity_supervisor_chimp.value,
...
# Studio
MONKEYS_STUDIO_A: Sequence[str] = [Loc.studio_ukki_yan.value]

MONKEYS_STUDIO_B: Sequence[str] = [Loc.studio_ukkipuss.value, Loc.studio_minoh.value, Loc.studio_monta.value]

MONKEYS_STUDIO_C: Sequence[str] = [Loc.studio_pipopam.value, Loc.studio_monpii_ukkichi.value, Loc.studio_gabimon.value]

MONKEYS_STUDIO_D: Sequence[str] = [Loc.studio_bananamon.value]

MONKEYS_STUDIO_D1: Sequence[str] = [Loc.studio_mokinza.value]

MONKEYS_STUDIO_E: Sequence[str] = [
    Loc.studio_ukki_lee_ukki.value,
    Loc.studio_ukkida_jiro.value,
    Loc.studio_sal_ukindo.value,
]

MONKEYS_STUDIO_F1: Sequence[str] = [Loc.studio_gimminey.value, Loc.studio_hant.value]

MONKEYS_STUDIO_F: Sequence[str] = [Loc.studio_chippino.value]

MONKEYS_STUDIO_G: Sequence[str] = [
    Loc.studio_ukki_paul.value,
    Loc.studio_sally_mon.value,
    Loc.studio_bonly.value,
    Loc.studio_monly.value,
]
...
# Halloween
MONKEYS_HALLOWEEN_A1: Sequence[str] = [Loc.halloween_monkichiro.value]

MONKEYS_HALLOWEEN_A: Sequence[str] = [
    Loc.halloween_leomon.value,
    Loc.halloween_uikkun.value,
    Loc.halloween_take_ukita.value,
]

MONKEYS_HALLOWEEN_B: Sequence[str] = [Loc.halloween_bonbon.value, Loc.halloween_chichi.value]

MONKEYS_HALLOWEEN_C: Sequence[str] = [Loc.halloween_ukkisuke.value, Loc.halloween_chibi_sally.value]

MONKEYS_HALLOWEEN_C2: Sequence[str] = [Loc.halloween_ukkison.value]

MONKEYS_HALLOWEEN_D: Sequence[str] = [Loc.halloween_saruhotep.value]

MONKEYS_HALLOWEEN_D1: Sequence[str] = [Loc.halloween_ukkito.value]

MONKEYS_HALLOWEEN_D2: Sequence[str] = [Loc.halloween_monzally.value, Loc.halloween_ukkiami.value]

MONKEYS_HALLOWEEN_E: Sequence[str] = [
    Loc.halloween_monjan.value,
    Loc.halloween_nattchan.value,
    Loc.halloween_kabochin.value,
    Loc.halloween_ukki_mon.value,
]

MONKEYS_HALLOWEEN_F: Sequence[str] = [Loc.halloween_mumpkin.value]

MONKEYS_HALLOWEEN: Sequence[str] = [
    *MONKEYS_HALLOWEEN_A1,
    *MONKEYS_HALLOWEEN_A,
    *MONKEYS_HALLOWEEN_B,
    *MONKEYS_HALLOWEEN_C,
    *MONKEYS_HALLOWEEN_C2,
    *MONKEYS_HALLOWEEN_D,
    *MONKEYS_HALLOWEEN_D1,
    *MONKEYS_HALLOWEEN_D2,
    *MONKEYS_HALLOWEEN_E,
    *MONKEYS_HALLOWEEN_F,
]

# Western
MONKEYS_WESTERN_A: Sequence[str] = [Loc.western_morrey.value, Loc.western_jomi.value, Loc.western_tammy.value]

MONKEYS_WESTERN_B: Sequence[str] = [
    Loc.western_ukki_gigolo.value,
    Loc.western_monboron.value,
    Loc.western_west_ukki.value,
]

MONKEYS_WESTERN_C: Sequence[str] = [
    Loc.western_lucky_woo.value,
    Loc.western_pamela.value,
    Loc.western_ukki_monber.value,
    Loc.western_gaukichi.value,
]
...
MONKEYS_WESTERN_D3: Sequence[str] = [
    Loc.western_jay_mohn.value,
    Loc.western_munkee_joe.value,
    Loc.western_saru_chison.value,
    Loc.western_jaja_jamo.value,
]

MONKEYS_WESTERN_E: Sequence[str] = [Loc.western_chammy_mo.value, Loc.western_golozo.value]

MONKEYS_WESTERN_E1: Sequence[str] = [
    Loc.western_golon_moe.value,
]

MONKEYS_WESTERN_F: Sequence[str] = [Loc.western_ukkia_munbo.value, Loc.western_mon_johny.value]
...
# Boss2
MONKEYS_BOSS2: Sequence[str] = [Loc.boss_monkey_blue.value]

# Onsen
MONKEYS_ONSEN_A: Sequence[str] = [Loc.onsen_chabimon.value, Loc.onsen_ukki_ichiro.value]

MONKEYS_ONSEN_A1M: Sequence[str] = [Loc.onsen_kiichiro.value, Loc.onsen_saru_sam.value]

MONKEYS_ONSEN_A2M: Sequence[str] = [Loc.onsen_michiyan.value, Loc.onsen_tome_san.value]

MONKEYS_ONSEN_B: Sequence[str] = [
    Loc.onsen_ukki_emon.value,
    Loc.onsen_moki.value,
    Loc.onsen_ukimi.value,
    Loc.onsen_domobeh.value,
]

MONKEYS_ONSEN_C: Sequence[str] = [
    Loc.onsen_sam_san.value,
    Loc.onsen_donkichi.value,
    Loc.onsen_minokichi.value,
    Loc.onsen_tatabo.value,
]

MONKEYS_ONSEN_D: Sequence[str] = [Loc.onsen_michiro.value, Loc.onsen_gen_san.value]

MONKEYS_ONSEN_D1: Sequence[str] = [Loc.onsen_kimi_san.value]

MONKEYS_ONSEN_E: Sequence[str] = [Loc.onsen_mujakin.value, Loc.onsen_mihachin.value, Loc.onsen_fuji_chan.value]
...
MONKEYS_SNOWFESTA_A: Sequence[str] = [
    ...
    Loc.snowfesta_konzo.value,
    Loc.snowfesta_saburota.value,
    Loc.snowfesta_mitsuro.value,
    Loc.snowfesta_takuo.value,
    Loc.snowfesta_konkichi.value,
]

MONKEYS_SNOWFESTA_B: Sequence[str] = [Loc.snowfesta_fumikichi.value, Loc.snowfesta_pipotron_yellow.value]

MONKEYS_SNOWFESTA_C: Sequence[str] = [
    Loc.snowfesta_tamubeh.value,
    Loc.snowfesta_kimikichi.value,
    Loc.snowfesta_gonbeh.value,
]

MONKEYS_SNOWFESTA_D: Sequence[str] = [Loc.snowfesta_shimmy.value]

MONKEYS_SNOWFESTA_E: Sequence[str] = [
    Loc.snowfesta_mako.value,
    Loc.snowfesta_miko.value,
    Loc.snowfesta_tamio.value,
    Loc.snowfesta_jeitan.value,
    Loc.snowfesta_ukki_jii.value,
]

MONKEYS_SNOWFESTA_F: Sequence[str] = [Loc.snowfesta_akki_bon.value]

MONKEYS_SNOWFESTA_G: Sequence[str] = [
    Loc.snowfesta_kimi_chan.value,
    Loc.snowfesta_sae_chan.value,
    Loc.snowfesta_tassan.value,
...
# Edotown
MONKEYS_EDOTOWN_A: Sequence[str] = [Loc.edotown_pipo_tobi.value, Loc.edotown_masan.value, Loc.edotown_mohachi.value]

MONKEYS_EDOTOWN_B: Sequence[str] = [
    Loc.edotown_mon_ninpo.value,
    Loc.edotown_yosio.value,
    Loc.edotown_fatty_mcfats.value,
]
...
MONKEYS_EDOTOWN_C1: Sequence[str] = [Loc.edotown_kikimaru.value]

MONKEYS_EDOTOWN_C2: Sequence[str] = [Loc.edotown_uziko.value, Loc.edotown_gp.value]

MONKEYS_EDOTOWN_D: Sequence[str] = [
    Loc.edotown_walter.value,
    Loc.edotown_monkibeth.value,
    Loc.edotown_babuzo.value,
    Loc.edotown_fishy_feet.value,
    Loc.edotown_pipo_torin.value,
]

MONKEYS_EDOTOWN_E: Sequence[str] = [Loc.edotown_tomi.value, Loc.edotown_master_pan.value]

MONKEYS_EDOTOWN_F: Sequence[str] = [
    Loc.edotown_monchin_chi.value,
    Loc.edotown_masachi.value,
    Loc.edotown_golota.value,
    Loc.edotown_kinsuke.value,
]
...
# Boss3
MONKEYS_BOSS3: Sequence[str] = [Loc.boss_monkey_yellow.value]

# Heaven
MONKEYS_HEAVEN_A: Sequence[str] = [Loc.heaven_ukkichi.value, Loc.heaven_chomon.value, Loc.heaven_ukkido.value]

MONKEYS_HEAVEN_B: Sequence[str] = [
    Loc.heaven_kyamio.value,
    Loc.heaven_talupon.value,
    Loc.heaven_bokitan.value,
    Loc.heaven_tami.value,
    Loc.heaven_micchino.value,
]

MONKEYS_HEAVEN_C: Sequence[str] = [
    Loc.heaven_talurin.value,
    Loc.heaven_occhimon.value,
    Loc.heaven_mikkurin.value,
    Loc.heaven_kicchino.value,
    Loc.heaven_kimurin.value,
    Loc.heaven_sakkano.value,
]

MONKEYS_HEAVEN_D: Sequence[str] = [Loc.heaven_camino.value, Loc.heaven_valuccha.value]

MONKEYS_HEAVEN_E: Sequence[str] = [
    Loc.heaven_pisuke.value,
    Loc.heaven_kansuke.value,
    Loc.heaven_pohta.value,
    Loc.heaven_keisuke.value,
]
...
# Toyhouse
MONKEYS_TOYHOUSE_A: Sequence[str] = [Loc.toyhouse_pikkori.value, Loc.toyhouse_talukki.value, Loc.toyhouse_pinkino.value]

MONKEYS_TOYHOUSE_B: Sequence[str] = [
    Loc.toyhouse_bon_mota.value,
    Loc.toyhouse_bon_verna.value,
    Loc.toyhouse_bon_papa.value,
    Loc.toyhouse_bon_mama.value,
]

MONKEYS_TOYHOUSE_B1: Sequence[str] = [Loc.toyhouse_kalkin.value]

MONKEYS_TOYHOUSE_C: Sequence[str] = [
    Loc.toyhouse_pakun.value,
    Loc.toyhouse_ukki_x.value,
    Loc.toyhouse_mon_gareji.value,
    Loc.toyhouse_shouji.value,
    Loc.toyhouse_woo_makka.value,
]

MONKEYS_TOYHOUSE_D: Sequence[str] = [
    Loc.toyhouse_monto.value,
    Loc.toyhouse_mokitani.value,
    Loc.toyhouse_namigo.value,
    Loc.toyhouse_pipotron_red.value,
]

MONKEYS_TOYHOUSE_E: Sequence[str] = [Loc.toyhouse_master_loafy.value]

MONKEYS_TOYHOUSE_F: Sequence[str] = [Loc.toyhouse_golonero.value]

MONKEYS_TOYHOUSE_G: Sequence[str] = [Loc.toyhouse_kocho.value]

MONKEYS_TOYHOUSE_H: Sequence[str] = [
    Loc.toyhouse_tam_konta.value,
    Loc.toyhouse_tam_mimiko.value,
    Loc.toyhouse_tam_papa.value,
...
# Iceland
MONKEYS_ICELAND_A: Sequence[str] = [Loc.iceland_bikupuri.value, Loc.iceland_ukkisu.value]

MONKEYS_ICELAND_A1: Sequence[str] = [
    Loc.iceland_ukki_ami.value,
]

MONKEYS_ICELAND_A2: Sequence[str] = [Loc.iceland_balio.value]

MONKEYS_ICELAND_B: Sequence[str] = [Loc.iceland_kimkon.value, Loc.iceland_ukkina.value, Loc.iceland_kushachin.value]

MONKEYS_ICELAND_C: Sequence[str] = [Loc.iceland_malikko.value, Loc.iceland_bolikko.value]

MONKEYS_ICELAND_D: Sequence[str] = [Loc.iceland_iceymon.value, Loc.iceland_mokkidon.value]

MONKEYS_ICELAND_E: Sequence[str] = [Loc.iceland_jolly_mon.value, Loc.iceland_hikkori.value, Loc.iceland_rammy.value]

MONKEYS_ICELAND_F: Sequence[str] = [
    Loc.iceland_monkino.value,
    Loc.iceland_kyam.value,
    Loc.iceland_kappino.value,
    Loc.iceland_kris_krimon.value,
]
...
# Arabian
MONKEYS_ARABIAN_A: Sequence[str] = [Loc.arabian_scorpi_mon.value, Loc.arabian_minimon.value, Loc.arabian_moontero.value]

MONKEYS_ARABIAN_B: Sequence[str] = [
    Loc.arabian_ukki_son.value,
    Loc.arabian_ukki_jeff.value,
    Loc.arabian_saru_maru.value,
    Loc.arabian_genghis_mon.value,
    Loc.arabian_cup_o_mon.value,
]

MONKEYS_ARABIAN_C: Sequence[str] = [Loc.arabian_nijal.value, Loc.arabian_apey_jones.value, Loc.arabian_golden_mon.value]

MONKEYS_ARABIAN_C1: Sequence[str] = [Loc.arabian_ukki_mamba.value, Loc.arabian_crazy_ol_mon.value]

MONKEYS_ARABIAN_E: Sequence[str] = [
    Loc.arabian_shamila.value,
    Loc.arabian_tamiyanya.value,
    Loc.arabian_salteenz.value,
    Loc.arabian_dancing_mia.value,
]

MONKEYS_ARABIAN_F: Sequence[str] = [
    Loc.arabian_miccho.value,
    Loc.arabian_kisha.value,
    Loc.arabian_gimuccho.value,
    Loc.arabian_wojin.value,
]

MONKEYS_ARABIAN_G: Sequence[str] = [Loc.arabian_princess_judy.value]
...
# Boss4
MONKEYS_BOSS4: Sequence[str] = [Loc.boss_monkey_pink.value]

# Asia
MONKEYS_ASIA_A: Sequence[str] = [Loc.asia_pincher_mon.value]

MONKEYS_ASIA_A1: Sequence[str] = [Loc.asia_salumani.value, Loc.asia_salulu.value]

MONKEYS_ASIA_A4: Sequence[str] = [Loc.asia_baku.value]

MONKEYS_ASIA_A6: Sequence[str] = [Loc.asia_ukki_mat.value, Loc.asia_salunch.value]

MONKEYS_ASIA_B: Sequence[str] = [Loc.asia_mong_popo.value, Loc.asia_mohcha.value, Loc.asia_kamcha.value]

MONKEYS_ASIA_B1: Sequence[str] = [Loc.asia_bimocha.value, Loc.asia_gimchin.value]

MONKEYS_ASIA_B2: Sequence[str] = [Loc.asia_kamaccha.value]

MONKEYS_ASIA_D: Sequence[str] = [Loc.asia_gyamu.value, Loc.asia_tartan.value]

MONKEYS_ASIA_D2: Sequence[str] = [Loc.asia_takumon.value, Loc.asia_ukki_ether.value]

MONKEYS_ASIA_E: Sequence[str] = [Loc.asia_molzone.value]

MONKEYS_ASIA_E2: Sequence[str] = [Loc.asia_chappio.value, Loc.asia_pomoah.value]

MONKEYS_ASIA_F: Sequence[str] = [
    Loc.asia_gucchai.value,
    Loc.asia_makaccho.value,
    Loc.asia_gamaran.value,
    Loc.asia_larry.value,
]
...
# Plane
MONKEYS_PLANE_A: Sequence[str] = [Loc.plane_romo.value, Loc.plane_temko.value]

MONKEYS_PLANE_A1: Sequence[str] = [Loc.plane_ukkigawa.value]

MONKEYS_PLANE_B: Sequence[str] = [Loc.plane_mokkido.value]

MONKEYS_PLANE_B1: Sequence[str] = [Loc.plane_pont.value]

MONKEYS_PLANE_B2: Sequence[str] = [Loc.plane_gamish.value]

MONKEYS_PLANE_C: Sequence[str] = [Loc.plane_takmon.value, Loc.plane_mukita.value]

MONKEYS_PLANE_C1: Sequence[str] = [Loc.plane_prince_bertus.value, Loc.plane_chai_bunny.value]

MONKEYS_PLANE_D: Sequence[str] = [Loc.plane_tamrai.value, Loc.plane_pipotron_blue.value]

MONKEYS_PLANE_D1: Sequence[str] = [Loc.plane_kemunpa.value]

MONKEYS_PLANE_E: Sequence[str] = [Loc.plane_mabaras.value, Loc.plane_tamoos.value, Loc.plane_kimoto.value]

MONKEYS_PLANE_F1: Sequence[str] = [Loc.plane_octavian.value]

MONKEYS_PLANE_G: Sequence[str] = [
    Loc.plane_samuel.value,
    Loc.plane_coril.value,
    Loc.plane_bont.value,
    Loc.plane_delly.value,
]

MONKEYS_PLANE_H: Sequence[str] = [Loc.plane_jeloh.value, Loc.plane_bongo.value]
...
MONKEYS_HONG_A1: Sequence[str] = [Loc.hong_donto_koi.value, Loc.hong_po_kin_ki.value]

MONKEYS_HONG_A2: Sequence[str] = [
    Loc.hong_dally.value,
]

MONKEYS_HONG_B: Sequence[str] = [Loc.hong_shinchi.value, Loc.hong_doh_tsuitaro.value]

MONKEYS_HONG_B1: Sequence[str] = [
    Loc.hong_ukki_chan.value,
    Loc.hong_uki_uki.value,
    Loc.hong_muki_muki.value,
    Loc.hong_hi_uchi_ishi.value,
]

MONKEYS_HONG_C: Sequence[str] = [
    Loc.hong_bassili_ukki.value,
    Loc.hong_pikon.value,
    Loc.hong_bankan.value,
    Loc.hong_sukei.value,
    Loc.hong_giyan.value,
]

MONKEYS_HONG_C1: Sequence[str] = [Loc.hong_danchi.value]

MONKEYS_HONG_C2: Sequence[str] = [Loc.hong_gala_waruo.value]

MONKEYS_HONG_D: Sequence[str] = [Loc.hong_muchaki.value]

MONKEYS_HONG_E: Sequence[str] = [Loc.hong_yoh_kitana.value, Loc.hong_goshi_andos.value, Loc.hong_pukuman.value]

MONKEYS_HONG_E1: Sequence[str] = [Loc.hong_block_master.value]

MONKEYS_HONG_F: Sequence[str] = [
    Loc.hong_tompo.value,
    Loc.hong_wootan.value,
    Loc.hong_chechin.value,
    Loc.hong_hapcho.value,
]

MONKEYS_HONG_G: Sequence[str] = [Loc.hong_bonmos.value, Loc.hong_dark_master.value]

MONKEYS_HONG_H: Sequence[str] = [Loc.hong_teh_isu.value, Loc.hong_ponja.value]
...
# boss5
MONKEYS_BOSS5: Sequence[str] = [Loc.boss_monkey_red.value]

# Bay
MONKEYS_BAY_A: Sequence[str] = [Loc.bay_nadamon.value, Loc.bay_patoya.value]

MONKEYS_BAY_A1: Sequence[str] = [Loc.bay_gumbo.value, Loc.bay_pehyan.value]

MONKEYS_BAY_A6: Sequence[str] = [Loc.bay_mokito.value]

MONKEYS_BAY_B: Sequence[str] = [
    Loc.bay_pipo_kate.value,
    Loc.bay_samtan.value,
    Loc.bay_pokkine.value,
    Loc.bay_daban.value,
]

MONKEYS_BAY_C: Sequence[str] = [
    Loc.bay_keiichi.value,
    Loc.bay_mcbreezy.value,
]

MONKEYS_BAY_C1: Sequence[str] = [
    Loc.bay_shiny_pete.value,
    Loc.bay_landon.value,
    Loc.bay_ronson.value,
    Loc.bay_gimo.value,
]

MONKEYS_BAY_D: Sequence[str] = [Loc.bay_hiroshi.value, Loc.bay_mibon.value, Loc.bay_bololon.value]

MONKEYS_BAY_D1: Sequence[str] = [Loc.bay_nakabi.value]

MONKEYS_BAY_E: Sequence[str] = [Loc.bay_doemos.value]

MONKEYS_BAY_E2: Sequence[str] = [Loc.bay_gimi_gimi.value, Loc.bay_pokkini.value, Loc.bay_bokino.value]

MONKEYS_BAY_E3: Sequence[str] = [Loc.bay_jimo.value]

MONKEYS_BAY_E4: Sequence[str] = [Loc.bay_kazuo.value]

MONKEYS_BAY_F: Sequence[str] = [Loc.bay_makidon.value, Loc.bay_dogy.value, Loc.bay_gibdon.value, Loc.bay_buligie.value]
...
# Tomo
MONKEYS_TOMO_A: Sequence[str] = [Loc.tomo_kichibeh.value, Loc.tomo_bonchicchi.value, Loc.tomo_mikibon.value]

MONKEYS_TOMO_B: Sequence[str] = [
    Loc.tomo_dj_tamo.value,
    Loc.tomo_ukkinaka.value,
    Loc.tomo_ukkine.value,
    Loc.tomo_pon_jiro.value,
]

MONKEYS_TOMO_C: Sequence[str] = [
    Loc.tomo_chimpy.value,
    Loc.tomo_kajitan.value,
    Loc.tomo_uka_uka.value,
    Loc.tomo_mil_mil.value,
]

MONKEYS_TOMO_E: Sequence[str] = [Loc.tomo_taimon.value]

MONKEYS_TOMO_E1: Sequence[str] = [Loc.tomo_goro_san.value]

MONKEYS_TOMO_E2: Sequence[str] = [Loc.tomo_reiji.value]

MONKEYS_TOMO_E3: Sequence[str] = [Loc.tomo_ponta.value, Loc.tomo_tomio.value, Loc.tomo_gario.value]

MONKEYS_TOMO_F2: Sequence[str] = [Loc.tomo_dj_pari.value]

MONKEYS_TOMO_F: Sequence[str] = [Loc.tomo_mitsuo.value]

MONKEYS_TOMO_G: Sequence[str] = [Loc.tomo_pipo_ron.value, Loc.tomo_mikita.value, Loc.tomo_riley.value]

MONKEYS_TOMO_H: Sequence[str] = [Loc.tomo_sal_13.value, Loc.tomo_sal_12.value]

MONKEYS_TOMO_I: Sequence[str] = [
    Loc.tomo_tomu.value,
    Loc.tomo_breadacus.value,
    Loc.tomo_ukkigoro.value,
    Loc.tomo_ukiji.value,
]

MONKEYS_TOMO_J: Sequence[str] = [Loc.tomo_tomimon.value]
...
# boss6
MONKEYS_BOSS6: Sequence[str] = [Loc.boss_tomoki.value]

# Space
MONKEYS_SPACE_A: Sequence[str] = [Loc.space_poko.value, Loc.space_gamuo.value, Loc.space_mukikko.value]

MONKEYS_SPACE_B: Sequence[str] = [
    Loc.space_moto_ukki.value,
    Loc.space_jimi_jami.value,
    Loc.space_genbo.value,
    Loc.space_twin_mitty.value,
]

MONKEYS_SPACE_D: Sequence[str] = [
    Loc.space_uttey.value,
    Loc.space_emma.value,
    Loc.space_dokicchi.value,
    Loc.space_kamicchi.value,
    Loc.space_ukki_monda.value,
    Loc.space_porokko.value,
    Loc.space_zonelin.value,
]

MONKEYS_SPACE_E: Sequence[str] = [
    Loc.space_tamano.value,
    Loc.space_nelson.value,
    Loc.space_koloneh.value,
    Loc.space_miluchy.value,
    Loc.space_robert.value,
    Loc.space_fronson.value,
    Loc.space_demekin.value,
]

MONKEYS_SPACE_F: Sequence[str] = [Loc.space_kikuyoshi.value, Loc.space_freet.value, Loc.space_chico.value]

MONKEYS_SPACE_F1: Sequence[str] = [Loc.space_gamurin.value]

MONKEYS_SPACE_F2: Sequence[str] = [
    Loc.space_pipo_mon.value,
    Loc.space_gam_gam.value,
    Loc.space_doronbo.value,
    Loc.space_benja.value,
]
MONKEYS_SPACE_G: Sequence[str] = [Loc.space_macchan.value, Loc.space_rokkun.value]

MONKEYS_SPACE_G1: Sequence[str] = [
    Loc.space_ukki_love.value,
    Loc.space_momongo.value,
    Loc.space_moepi.value,
    Loc.space_pumon.value,
    Loc.space_makiban.value,
]

MONKEYS_SPACE_H: Sequence[str] = [
    Loc.space_upis.value,
    Loc.space_mondatta.value,
    Loc.space_gicchom.value,
    Loc.space_barire.value,
]

MONKEYS_SPACE_I: Sequence[str] = [Loc.space_sal_10.value, Loc.space_sal_11.value]
MONKEYS_SPACE_K: Sequence[str] = [Loc.space_sal_3000.value]
...
MONKEYS_SPECTER: Sequence[str] = [Loc.boss_specter.value]

MONKEYS_SPECTER_FINALE: Sequence[str] = [Loc.boss_specter_final.value]
...
MONKEYS_PASSWORDS: Sequence[str] = [
    ...
    Loc.snowfesta_pipotron_yellow.value,
    Loc.toyhouse_pipotron_red.value,
    Loc.plane_pipotron_blue.value,
    Loc.hong_dark_master.value,
...
CAMERAS_MASTER: Sequence[str] = [
    Loc.seaside_cam.value,
    Loc.woods_cam.value,
    Loc.castle_cam.value,
    Loc.ciscocity_cam.value,
    Loc.studio_cam.value,
    Loc.halloween_cam.value,
    Loc.western_cam.value,
    Loc.onsen_cam.value,
    Loc.snowfesta_cam.value,
    Loc.edotown_cam.value,
    Loc.heaven_cam.value,
    Loc.toyhouse_cam.value,
    Loc.iceland_cam.value,
    Loc.arabian_cam.value,
    Loc.asia_cam.value,
    Loc.plane_cam.value,
    Loc.hong_cam.value,
    Loc.bay_cam.value,
...
CAMERAS_DIRECTORY: dict[str, str] = {
    Stage.channel_seaside.value: Loc.seaside_cam.value,
    Stage.channel_woods.value: Loc.woods_cam.value,
    Stage.channel_castle.value: Loc.castle_cam.value,
    Stage.channel_ciscocity.value: Loc.ciscocity_cam.value,
    Stage.channel_studio.value: Loc.studio_cam.value,
    Stage.channel_halloween.value: Loc.halloween_cam.value,
    Stage.channel_western.value: Loc.western_cam.value,
    Stage.channel_onsen.value: Loc.onsen_cam.value,
    Stage.channel_snowfesta.value: Loc.snowfesta_cam.value,
    Stage.channel_edotown.value: Loc.edotown_cam.value,
    Stage.channel_heaven.value: Loc.heaven_cam.value,
    Stage.channel_toyhouse.value: Loc.toyhouse_cam.value,
    Stage.channel_iceland.value: Loc.iceland_cam.value,
    Stage.channel_arabian.value: Loc.arabian_cam.value,
    Stage.channel_asia.value: Loc.asia_cam.value,
    Stage.channel_plane.value: Loc.plane_cam.value,
    Stage.channel_hong.value: Loc.hong_cam.value,
    Stage.channel_bay.value: Loc.bay_cam.value,
    Stage.channel_tomo.value: Loc.tomo_cam.value,
    Stage.channel_space.value: Loc.space_cam.value,
}
...
## Cellphones
# Seaside
CELLPHONES_SEASIDE_A: Sequence[str] = [Loc.tele_000.value, Loc.tele_002.value, Loc.tele_003.value]

CELLPHONES_SEASIDE_B: Sequence[str] = [Loc.tele_004ss.value]

CELLPHONES_SEASIDE: Sequence[str] = [*CELLPHONES_SEASIDE_A, *CELLPHONES_SEASIDE_B]

# Woods
CELLPHONES_WOODS_A: Sequence[str] = [Loc.tele_001.value, Loc.tele_006.value, Loc.tele_007.value, Loc.tele_004wo.value]

CELLPHONES_WOODS_B: Sequence[str] = [Loc.tele_008.value]

CELLPHONES_WOODS: Sequence[str] = [*CELLPHONES_WOODS_A, *CELLPHONES_WOODS_B]

# Castle
CELLPHONES_CASTLE_A: Sequence[str] = [Loc.tele_029.value]

CELLPHONES_CASTLE_A1: Sequence[str] = [Loc.tele_010.value, Loc.tele_009.value]

CELLPHONES_CASTLE_A_ALL: Sequence[str] = [*CELLPHONES_CASTLE_A, *CELLPHONES_CASTLE_A1]

CELLPHONES_CASTLE_D: Sequence[str] = [Loc.tele_011.value]

CELLPHONES_CASTLE: Sequence[str] = [*CELLPHONES_CASTLE_A, *CELLPHONES_CASTLE_A1, *CELLPHONES_CASTLE_D]

CELLPHONES_CISCOCITY_A: Sequence[str] = [Loc.tele_013.value, Loc.tele_012cc.value]

CELLPHONES_CISCOCITY: Sequence[str] = [*CELLPHONES_CISCOCITY_A]

CELLPHONES_STUDIO_A: Sequence[str] = [Loc.tele_062.value]

CELLPHONES_STUDIO_B1: Sequence[str] = [Loc.tele_014.value]

CELLPHONES_STUDIO_F: Sequence[str] = [Loc.tele_030tv.value]

CELLPHONES_STUDIO: Sequence[str] = [*CELLPHONES_STUDIO_A, *CELLPHONES_STUDIO_B1, *CELLPHONES_STUDIO_F]

CELLPHONES_HALLOWEEN_A: Sequence[str] = [Loc.tele_052.value]

CELLPHONES_HALLOWEEN_A1: Sequence[str] = [Loc.tele_035.value]

CELLPHONES_HALLOWEEN_C1: Sequence[str] = [Loc.tele_016.value]

CELLPHONES_HALLOWEEN_D: Sequence[str] = [Loc.tele_017.value]

CELLPHONES_HALLOWEEN_A_ALL: Sequence[str] = [
    *CELLPHONES_HALLOWEEN_A,
    *CELLPHONES_HALLOWEEN_A1,
]

CELLPHONES_HALLOWEEN: Sequence[str] = [
    *CELLPHONES_HALLOWEEN_A,
    *CELLPHONES_HALLOWEEN_A1,
    *CELLPHONES_HALLOWEEN_C1,
    *CELLPHONES_HALLOWEEN_D,
]

CELLPHONES_WESTERN_A: Sequence[str] = [Loc.tele_018.value]

CELLPHONES_WESTERN_F: Sequence[str] = [Loc.tele_051.value]

CELLPHONES_WESTERN_E: Sequence[str] = [Loc.tele_019.value]

CELLPHONES_WESTERN: Sequence[str] = [*CELLPHONES_WESTERN_A, *CELLPHONES_WESTERN_F, *CELLPHONES_WESTERN_E]

CELLPHONES_ONSEN_A: Sequence[str] = [Loc.tele_020.value, Loc.tele_063.value]

CELLPHONES_ONSEN_D1: Sequence[str] = [Loc.tele_021on.value]

CELLPHONES_ONSEN: Sequence[str] = [*CELLPHONES_ONSEN_A, *CELLPHONES_ONSEN_D1]

CELLPHONES_SNOWFESTA_F: Sequence[str] = [Loc.tele_022sf.value]

CELLPHONES_SNOWFESTA: Sequence[str] = [*CELLPHONES_SNOWFESTA_F]

CELLPHONES_EDOTOWN_A1: Sequence[str] = [Loc.tele_023.value]

CELLPHONES_EDOTOWN_B1: Sequence[str] = [Loc.tele_025.value]

CELLPHONES_EDOTOWN_C1: Sequence[str] = [Loc.tele_024.value]

CELLPHONES_EDOTOWN_C2: Sequence[str] = [Loc.tele_026.value]

CELLPHONES_EDOTOWN_C_ALL: Sequence[str] = [*CELLPHONES_EDOTOWN_C1, *CELLPHONES_EDOTOWN_C2]

CELLPHONES_EDOTOWN: Sequence[str] = [
    *CELLPHONES_EDOTOWN_A1,
    *CELLPHONES_EDOTOWN_B1,
    *CELLPHONES_EDOTOWN_C1,
    *CELLPHONES_EDOTOWN_C2,
]

CELLPHONES_HEAVEN_A1: Sequence[str] = [Loc.tele_028.value]

CELLPHONES_HEAVEN: Sequence[str] = [*CELLPHONES_HEAVEN_A1]

CELLPHONES_TOYHOUSE_C: Sequence[str] = [Loc.tele_012tv.value]

CELLPHONES_TOYHOUSE_G: Sequence[str] = [Loc.tele_030ty.value]

CELLPHONES_TOYHOUSE: Sequence[str] = [*CELLPHONES_TOYHOUSE_C, *CELLPHONES_TOYHOUSE_G]

CELLPHONES_ICELAND_A1: Sequence[str] = [Loc.tele_031.value]

CELLPHONES_ICELAND_D: Sequence[str] = [Loc.tele_021ic.value]

CELLPHONES_ICELAND: Sequence[str] = [*CELLPHONES_ICELAND_A1, *CELLPHONES_ICELAND_D]

CELLPHONES_ARABIAN_A: Sequence[str] = [Loc.tele_032.value, Loc.tele_033.value]

CELLPHONES_ARABIAN_B: Sequence[str] = [Loc.tele_042ar.value]

CELLPHONES_ARABIAN_E1: Sequence[str] = [Loc.tele_034.value]

CELLPHONES_ARABIAN: Sequence[str] = [*CELLPHONES_ARABIAN_A, *CELLPHONES_ARABIAN_B, *CELLPHONES_ARABIAN_E1]

CELLPHONES_ASIA_B: Sequence[str] = [Loc.tele_037.value]

CELLPHONES_ASIA_D1: Sequence[str] = [Loc.tele_015.value]

CELLPHONES_ASIA: Sequence[str] = [*CELLPHONES_ASIA_B, *CELLPHONES_ASIA_D1]

CELLPHONES_PLANE_E: Sequence[str] = [Loc.tele_022pl.value]

CELLPHONES_PLANE: Sequence[str] = [*CELLPHONES_PLANE_E]

CELLPHONES_HONG_A: Sequence[str] = [Loc.tele_039.value, Loc.tele_040h_a.value]

CELLPHONES_HONG_B1: Sequence[str] = [Loc.tele_040h_b.value]

CELLPHONES_HONG_D: Sequence[str] = [Loc.tele_042ho.value]

CELLPHONES_HONG: Sequence[str] = [*CELLPHONES_HONG_A, *CELLPHONES_HONG_B1, *CELLPHONES_HONG_D]

CELLPHONES_BAY_C: Sequence[str] = [Loc.tele_044.value]

CELLPHONES_BAY: Sequence[str] = [*CELLPHONES_BAY_C]

CELLPHONES_TOMO_A1: Sequence[str] = [Loc.tele_045.value]

CELLPHONES_TOMO: Sequence[str] = [*CELLPHONES_TOMO_A1]

CELLPHONES_SPACE_A: Sequence[str] = [Loc.tele_047.value]

CELLPHONES_SPACE_B: Sequence[str] = [Loc.tele_048.value]

CELLPHONES_SPACE: Sequence[str] = [*CELLPHONES_SPACE_A, *CELLPHONES_SPACE_B]
...
CELLPHONES_STAGE_DUPLICATES: Sequence[str] = [
    Stage.woods_a.value,
    Stage.toyhouse_c.value,
    Stage.iceland_d.value,
    Stage.plane_e.value,
    Stage.toyhouse_g.value,
    Stage.hong_b.value,
    Stage.hong_d.value,
]
...
CELLPHONES_MASTER: Sequence[str] = [
    ...
    *CELLPHONES_WOODS,
    *CELLPHONES_CASTLE,
    *CELLPHONES_CISCOCITY,
    *CELLPHONES_STUDIO,
    *CELLPHONES_HALLOWEEN,
    *CELLPHONES_WESTERN,
    *CELLPHONES_ONSEN,
    *CELLPHONES_SNOWFESTA,
    *CELLPHONES_EDOTOWN,
    *CELLPHONES_HEAVEN,
    *CELLPHONES_TOYHOUSE,
    *CELLPHONES_ICELAND,
...
CELLPHONES_DIRECTORY: dict[str, list[str]] = {
    Stage.channel_seaside.value: CELLPHONES_SEASIDE,
    Stage.channel_woods.value: CELLPHONES_WOODS,
    Stage.channel_castle.value: CELLPHONES_CASTLE,
    Stage.channel_ciscocity.value: CELLPHONES_CISCOCITY,
    Stage.channel_studio.value: CELLPHONES_STUDIO,
    Stage.channel_halloween.value: CELLPHONES_HALLOWEEN,
    Stage.channel_western.value: CELLPHONES_WESTERN,
    Stage.channel_onsen.value: CELLPHONES_ONSEN,
    Stage.channel_snowfesta.value: CELLPHONES_SNOWFESTA,
    Stage.channel_edotown.value: CELLPHONES_EDOTOWN,
    Stage.channel_heaven.value: CELLPHONES_HEAVEN,
    Stage.channel_toyhouse.value: CELLPHONES_TOYHOUSE,
    Stage.channel_iceland.value: CELLPHONES_ICELAND,
    Stage.channel_arabian.value: CELLPHONES_ARABIAN,
    Stage.channel_asia.value: CELLPHONES_ASIA,
    Stage.channel_plane.value: CELLPHONES_PLANE,
    Stage.channel_hong.value: CELLPHONES_HONG,
    Stage.channel_bay.value: CELLPHONES_BAY,
    Stage.channel_tomo.value: CELLPHONES_TOMO,
    Stage.channel_space.value: CELLPHONES_SPACE,
}

### [< --- EVENT GROUPS --- >]
EVENTS_CASTLE_B: Sequence[str] = [Events.castle_b_clapper.value]

EVENTS_CASTLE_A2: Sequence[str] = [Events.castle_a2_button.value]

EVENTS_CISCOCITY_D: Sequence[str] = [Events.ciscocity_d_exit.value]

EVENTS_CISCOCITY_C: Sequence[str] = [Events.ciscocity_c_button.value]

EVENTS_STUDIO_A1: Sequence[str] = [Events.studio_a1_button.value]

EVENTS_STUDIO_A2: Sequence[str] = [Events.studio_a2_button.value]

EVENTS_STUDIO_B1: Sequence[str] = [Events.studio_b1_button.value]

EVENTS_STUDIO_F: Sequence[str] = [Events.studio_f_tele_robo.value]

EVENTS_HALLOWEEN_B: Sequence[str] = [Events.halloween_b_jumbo_robo.value]

EVENTS_HALLOWEEN_B1: Sequence[str] = [Events.halloween_b1_jumbo_robo_shoot.value]

EVENTS_ONSEN_A: Sequence[str] = [Events.onsen_a_button.value]

EVENTS_SNOWFESTA_E: Sequence[str] = [Events.snowfesta_e_bell.value]

EVENTS_EDOTOWN_B1: Sequence[str] = [Events.edotown_b1_button.value]

EVENTS_EDOTOWN_E: Sequence[str] = [Events.edotown_e_scroll.value]

EVENTS_HEAVEN_B: Sequence[str] = [Events.heaven_b_clapper.value]

EVENTS_ICELAND_C: Sequence[str] = [Events.iceland_c_jumbo_robo.value]

EVENTS_ICELAND_E: Sequence[str] = [Events.iceland_e_button.value]

EVENTS_ARABIAN_C: Sequence[str] = [Events.arabian_c_golden_mon.value]

EVENTS_ARABIAN_C1: Sequence[str] = [Events.arabian_c1_exit.value]

EVENTS_ARABIAN_G: Sequence[str] = [Events.arabian_g_exit.value]

EVENTS_ASIA_A: Sequence[str] = [Events.asia_a_block.value]

EVENTS_ASIA_A1: Sequence[str] = [Events.asia_a1_block.value]

EVENTS_ASIA_A2: Sequence[str] = [Events.asia_a2_block.value]

EVENTS_ASIA_B2: Sequence[str] = [Events.asia_b2_button.value]

EVENTS_ASIA_E1: Sequence[str] = [Events.asia_e1_button.value]

EVENTS_PLANE_D1: Sequence[str] = [Events.plane_d1_clapper.value]

EVENTS_HONG_B: Sequence[str] = [Events.hong_b_kungfu.value]

EVENTS_HONG_B2: Sequence[str] = [Events.hong_b2_button.value]

EVENTS_BAY_A7: Sequence[str] = [Events.bay_a7_button.value]

EVENTS_BAY_A5: Sequence[str] = [Events.bay_a5_button.value]

EVENTS_BAY_E1: Sequence[str] = [Events.bay_e1_button.value]

EVENTS_TOMO_E2: Sequence[str] = [Events.tomo_e2_kungfu.value]

EVENTS_TOMO_G: Sequence[str] = [Events.tomo_g_button.value]

EVENTS_TOMO_H: Sequence[str] = [Events.tomo_h_button.value]

EVENTS_SPACE_E: Sequence[str] = [Events.space_e_button.value]

EVENTS_SPACE_G: Sequence[str] = [Events.space_g_button.value]

EVENTS_SPACE_G1: Sequence[str] = [Events.space_g1_button.value]

EVENTS_SPACE_F1: Sequence[str] = [Events.space_f1_kungfu.value]

EVENTS_SPACE_F2: Sequence[str] = [Events.space_f2_button.value]

EVENTS_SPACE_D: Sequence[str] = [Events.space_d_button.value]
...
SHOP_PROGRESSION_TOMO_ACCESS: Sequence[str] = [Loc.movie_tape_17.value]
...
SHOP_CATEGORIES_INDEX: Sequence[str] = [
    Loc.shop_morph_stock.value,
    Loc.hint_book.value,
    Loc.mon_fiction.value,
    Loc.channel_guide.value,
    Loc.bonus_rc_cars.value,
    Loc.minigames.value,
    Loc.lucky_photo.value,
    Loc.movie_tape.value,
    Loc.music_disc.value,
...
SHOP_PROGRESSION_INDEX: Sequence[Sequence[str]] = [
    SHOP_PROGRESSION_SEASIDE,
    SHOP_PROGRESSION_WOODS,
    SHOP_PROGRESSION_CASTLE,
    SHOP_PROGRESSION_BOSS1,
    SHOP_PROGRESSION_CISCOCITY,
    SHOP_PROGRESSION_STUDIO,
    SHOP_PROGRESSION_HALLOWEEN,
    SHOP_PROGRESSION_WESTERN,
    SHOP_PROGRESSION_BOSS2,
    SHOP_PROGRESSION_ONSEN,
    SHOP_PROGRESSION_SNOWFESTA,
    SHOP_PROGRESSION_EDOTOWN,
    SHOP_PROGRESSION_BOSS3,
    SHOP_PROGRESSION_HEAVEN,
    SHOP_PROGRESSION_TOYHOUSE,
    SHOP_PROGRESSION_ICELAND,
    SHOP_PROGRESSION_ARABIAN,
    SHOP_PROGRESSION_BOSS4,
    SHOP_PROGRESSION_ASIA,
    SHOP_PROGRESSION_PLANE,
    SHOP_PROGRESSION_HONG,
    SHOP_PROGRESSION_BOSS5,
    SHOP_PROGRESSION_BAY,
    SHOP_PROGRESSION_TOMO,
    SHOP_PROGRESSION_BOSS6,
    SHOP_PROGRESSION_SPACE,
    SHOP_PROGRESSION_SPECTER1,
    SHOP_PROGRESSION_ROUND2,
]
...
SHOP_COLLECTION_INDEX: Sequence[Sequence[str]] = [
    ...
    SHOP_COLLECTION_HINT_BOOK,
    SHOP_COLLECTION_MON_FICTION,
    SHOP_COLLECTION_CHANNEL_GUIDE,
    SHOP_COLLECTION_BONUS_RC_CARS,
    SHOP_COLLECTION_MINIGAMES,
    SHOP_COLLECTION_LUCKY_PHOTO,
    SHOP_COLLECTION_MOVIE_TAPE,
    SHOP_COLLECTION_MUSIC_DISC,
    SHOP_COLLECTION_GENIE_DANCE_MUSIC,
]
...
SHOP_GROUPINGS_DIRECTORY: dict[str, Sequence[str]] = {
    ...
    Loc.hobby_shop.value: [Loc.bonus_rc_cars.value, Loc.minigames.value, Loc.lucky_photo.value],
    Loc.music_shop.value: [Loc.movie_tape.value, Loc.music_shop.value, Loc.genie_dance_music.value],
}
...
LOCATIONS_INDEX: dict[str, Sequence[str]] = {
    ...
    for key in [
        *{*MONKEYS_INDEX.keys(), *CAMERAS_INDEX.keys(), *CELLPHONES_INDEX.keys(), *SHOP_CATEGORIES_DIRECTORY.keys()}
    ]
}
...
def generate_location_groups() -> dict[str, int]:
    ...
    groups.update({f"{k} Cellphones": [Cellphone_Name_to_ID[c] for c in v] for k, v in CELLPHONES_INDEX.items()})
