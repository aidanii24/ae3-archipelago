...
class Loc(BaseEnum):
    ...
    ## onsen
    onsen_chabimon              = "Chabimon"
    onsen_saru_sam              = "Saru Sam"
    onsen_kiichiro              = "Kiichiro"
    onsen_tome_san              = "Tome-san"
    onsen_michiyan              = "Michiyan"
    onsen_ukki_ichiro           = "Ukki Ichiro"
    onsen_ukki_emon             = "Ukki-emon"
    onsen_moki                  = "Moki"
    onsen_ukimi                 = "Ukimi"
    onsen_domobeh               = "Domobeh"
    onsen_sam_san               = "Sam-san"
    onsen_donkichi              = "Donkichi"
    onsen_minokichi             = "Minokichi"
    onsen_tatabo                = "Tatabo"
    onsen_kimi_san              = "Kimisan"
    onsen_michiro               = "Michiro"
    onsen_gen_san               = "Gen-san"
    onsen_mujakin               = "Mujakin"
    onsen_mihachin              = "Mihachin"
    onsen_fuji_chan             = "Fuji-chan"

    ## snowfesta
    snowfesta_kimisuke          = "Kimisuke"
    snowfesta_konzo             = "Konzo"
    snowfesta_saburota          = "Saburota"
    snowfesta_mitsuro           = "Mitsuro"
    snowfesta_takuo             = "Takuo"
    snowfesta_konkichi          = "Konkichi"
    snowfesta_fumikichi         = "Fumikichi"
    snowfesta_pipotron_yellow   = "Pipotron Yellow"
    snowfesta_tamubeh           = "Tamubeh"
    snowfesta_kimikichi         = "Kimikichi"
    snowfesta_gonbeh            = "Gonbeh"
    snowfesta_shimmy            = "Shimmy"
    snowfesta_mako              = "Mako"
    snowfesta_miko              = "Miko"
    snowfesta_tamio             = "Tamio"
    snowfesta_jeitan            = "Jeitan"
    snowfesta_ukki_jii          = "Ukki Jii"
    snowfesta_akki_bon          = "Akki-bon"
    snowfesta_kimi_chan         = "Kimi-chan"
    snowfesta_sae_chan          = "Sae-chan"
    snowfesta_tassan            = "Tassan"
    snowfesta_tomokun           = "Tomokun"

    ## edotown
    edotown_pipo_tobi           = "Pipo Tobi"
    edotown_masan               = "Masan"
    edotown_mohachi             = "Mohachi"
    edotown_mon_ninpo           = "Mon Ninpo"
    edotown_yosio               = "Yosio"
    edotown_fatty_mcfats        = "Fatty Mcfats"
    edotown_kikimaru            = "Kikimaru"
    edotown_tomoku_chan         = "Tomoku-chan"
    edotown_uziko               = "Uziko"
    edotown_gp                  = "GP"
    edotown_walter              = "Walter"
    edotown_monkibeth           = "Monkibeth"
    edotown_babuzo              = "Babuzo"
    edotown_fishy_feet          = "Fishy Feet"
    edotown_pipo_torin          = "Pipo Torin"
    edotown_tomi                = "Tomi"
    edotown_master_pan          = "Master Pan"
    edotown_monchin_chi         = "Monchin Chi"
    edotown_masachi             = "Masachi"
    edotown_golota              = "Golota"
    edotown_kinsuke             = "Kinsuke"
